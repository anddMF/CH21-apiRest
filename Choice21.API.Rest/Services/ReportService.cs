...
namespace Choice21.API.Rest.Services
{
    public class ReportService
    {
        ...
        public dynamic PostReport(Report model)
        {
            ...
            var query = $"INSERT INTO develop2020.cho2021_report (ID_CUSTOMER, ID_USER_ADMIN, ID_COMPANY, DT_REGISTER, DEAL, R_READ, TITLE, R_DESCRIPTION, R_KEY, R1_PIC1, R1_PIC2, R2_PIC1, R2_PIC2, R3_PIC1, R3_PIC2, R4_PIC1, R4_PIC2, R5_PIC1, R5_PIC2, R6_PIC1, R6_PIC2, R7_PIC1, R7_PIC2, R8_PIC1, R8_PIC2) VALUES (@Pid_customer, @Pid_admin, @Pid_company, @Pdt_register, @Pdeal, @Pread, @Ptitle, @Pdescription, @Pkey, @Pr1_pic1, @Pr1_pic2, @Pr2_pic1, @Pr2_pic2, @Pr3_pic1, @Pr3_pic2, @Pr4_pic1, @Pr4_pic2, @Pr5_pic1, @Pr5_pic2, @Pr6_pic1, @Pr6_pic2, @Pr7_pic1, @Pr7_pic2, @Pr8_pic1, @Pr8_pic2);";
